...
export class DualPublicationFoundation1760000000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "publication_profiles" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "endpointId" character varying(36) NOT NULL, "version" integer NOT NULL DEFAULT '1', "intentName" character varying(255), "descriptionForLlm" text, "operatorNotes" text, "inputAliases" jsonb, "constraints" jsonb, "examples" jsonb, "visibility" character varying(32) NOT NULL DEFAULT 'internal', "status" "public"."publication_profiles_status_enum" NOT NULL DEFAULT 'draft', "draftSource" character varying(32), "createdBy" character varying(36), "updatedBy" character varying(36), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_9fe456f7f44633ac89b7eaef420" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_31876d51ef77b629d1a4f8ca79" ON "publication_profiles" ("status") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_3228aa03bcb06a0b8d55a17893" ON "publication_profiles" ("endpointId") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "publication_profile_history" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "endpointId" character varying(36) NOT NULL, "publicationProfileId" character varying(36) NOT NULL, "version" integer NOT NULL, "snapshot" jsonb NOT NULL, "action" character varying(64) NOT NULL, "actorId" character varying(36), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_2c5ab38dc62055212651e213cc4" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_23df5b5d3a59b74df696be0cbf" ON "publication_profile_history" ("endpointId") `,
    );
    await queryRunner.query(
