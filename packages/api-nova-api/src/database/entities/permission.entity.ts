...
export const SYSTEM_PERMISSIONS = {
  ...
  MONITORING_PAYLOAD_READ: {
    name: 'monitoring:payload:read',
    description: 'Read captured invocation payloads',
    category: PermissionCategory.MONITORING,
    action: PermissionAction.READ,
    resource: 'monitoring',
    isSystem: true,
  },
  MONITORING_SOURCE_READ: {
    name: 'monitoring:source:read',
    description: 'Read raw invocation source IP information',
    category: PermissionCategory.MONITORING,
    action: PermissionAction.READ,
    resource: 'monitoring',
    isSystem: true,
  },
  MONITORING_SUBSCRIPTION_MANAGE: {
    name: 'monitoring:subscription:manage',
    description: 'Manage observability subscriptions and deliveries',
    category: PermissionCategory.MONITORING,
    action: PermissionAction.MANAGE,
    resource: 'monitoring',
    isSystem: true,
  },
  MONITORING_DELIVERY_RETRY: {
    name: 'monitoring:delivery:retry',
    description: 'Retry observability event deliveries',
    category: PermissionCategory.MONITORING,
    action: PermissionAction.EXECUTE,
    resource: 'monitoring',
    isSystem: true,
