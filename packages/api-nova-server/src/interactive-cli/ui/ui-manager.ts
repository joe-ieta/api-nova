...
export class UIManager {
  ...
  async showHelp(): Promise<void> {
    const helpContent = `
${chalk.hex(this.theme.colors.accent).bold('🚀 ApiNova - 交互式 CLI')}
...
• 项目主页: https://github.com/joe-ieta/api-nova
• 文档: https://github.com/joe-ieta/api-nova
• 问题反馈: https://github.com/joe-ieta/api-nova/issues
`;
