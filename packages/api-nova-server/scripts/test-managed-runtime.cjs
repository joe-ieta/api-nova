...
for(const defect of ['secret','digest','binding','anonymous','missing-auth','jwt','revision','host'])test('pre-listen '+defect+' failure emits fixed code and zero upstream sends',{timeout:15000},async t=>{
