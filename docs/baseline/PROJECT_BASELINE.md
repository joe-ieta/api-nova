...
This document is the single active project, product, and release baseline for the ApiNova repository. It consolidates the former project baseline, next development baseline, and V1 release baseline into one source of truth.
