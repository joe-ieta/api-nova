...
本批证据：[OBS-14-03E3 授权物理清理](./2026-09-26-obs-14-03e3-physical-cleanup.md)、[PROD-06 CAS 范围核定](./2026-09-26-prod-06-cas-scope-determination.md)、[MAIL-02 受控邮件投递](./2026-09-26-mail-02-controlled-delivery.md)、[SEC-F3-02D 本地 N 矩阵](./2026-09-26-f3-n-matrix-local.md)、[SEC-F3a-01 依赖可达性审计](./2026-09-26-dependency-reachability-audit.md)、[OBS-13-02 长期传输与慢客户端验收](./2026-09-26-obs-13-02-long-transport.md)、[OBS-14-03D 投递保留与导入墓碑](./2026-09-26-obs-14-03d-lifecycle-retention.md)。
...
本批证据：[SEC-A2-01B三入口拒绝矩阵](./2026-09-21-mcp-rejection-matrix.md)。
...
本批证据：[SEC-C3-02 Registry配置可信数据库归属验收](./2026-09-21-registry-db-ownership.md)。

本批证据：[SEC-C2-02 Windows秘密文件ACL验收](./2026-09-21-windows-secret-acl.md)。
...
本批证据：[锁定SDK会话与通知合同验证](./2026-09-21-sdk-session-contract.md)。

本批证据：[Consumer与Upstream分区和重载恢复](./2026-09-21-upstream-credential-management-ui.md)。

本批证据：[Header策略编译与安全接线准备](./2026-09-21-header-policy-compilation.md)。
...
本批证据：[Header策略缓存隔离与真实命中验收](./2026-09-22-header-cache-isolation.md)。
