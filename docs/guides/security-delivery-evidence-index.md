...
| SEC-F3-02B3b | [网络边界合同§4.3](./security-header-network-boundary-contract.md) | **READY**：B3a限定transport完成后解锁；接Parser host-only可信Site/Registry版本桥和bounded adapter，禁止legacy/global Agent回退。 |
