...
| SEC-F3-02B3b | [网络边界合同§4.3](./security-header-network-boundary-contract.md) | **IN_PROGRESS**：Parser host-only可信Site/Registry网络政策版本桥与bounded adapter已开工；默认不开生产网络模式，仅接受可信Snapshot与受限序列化输入，禁止legacy/global Agent回退。 |
