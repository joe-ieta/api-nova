...
| TP-F3 | SEC-F03；C4/D1/E1 | IN_PROGRESS | F3-01政策已冻结；A纯compiler、B1受控DNS及B2≤8MiB Buffer单跳transport primitive限定DONE。B3拆为a共享verified connection/Readable矩阵READY、b Parser host桥WAIT、c Gateway route桥WAIT；C同时依赖b/c并负责整操作版本/逐跳凭据/撤销，生产启用与完整SSRF防线均未完成 |
