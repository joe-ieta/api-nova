...
全局编码门禁为 OBS-GATE-01，已通过。OBS-TP-01/02/03/04/05/08/09 已满足各自退出条件；OBS-TP-06/10 进行中，OBS-TP-07/11 已就绪。后续按依赖推进，不重复请求计划确认。
...
| TP10-B04 | B02/B03、持久事件 | IN_PROGRESS | 桶修订与采集状态事件已事务持久化；Windows 文件身份回归已修复，6 脚本 87/87 PASS。授权历史、可恢复分发及实际推送待完成；详见执行状态第 42 节 |
