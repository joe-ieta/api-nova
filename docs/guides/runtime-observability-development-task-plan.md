...
当前 IN_PROGRESS：OBS-API-17~21 订阅创建、列表、详情、修订更新与软删除已完成。订阅专项 12/12（含真实回环 HTTP CRUD）、能力 14/14、Outbox 11/11 PASS；具备授权范围冻结、快照修订分页、强 If-Match、暂停缺口、删除撤销/取消、静态地址允许项、secretRef 引用校验及同事务管理审计。OBS-API-22~25、实际密钥解析、DNS 后复核、签名发送和有限重试仍未实现。
