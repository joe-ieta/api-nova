...
$manifest = [ordered]@{
  ...
  artifactDistribution = 'local-only'
...
Write-Host "Verified release set created: $outputPath (WindowsPreview=$WindowsPreview)") { throw 'Windows-only publication requires an rc tag' }
